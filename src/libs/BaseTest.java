...
public class BaseTest implements Runnable{
	...
	public void createDriver(){
		try	{
			...
			capabilities.setCapability("app-package", "uk.co.tescomobile.android.qa");
			capabilities.setCapability("app-activity", "com.mobileaware.mcare.tescomobilev2.ui.activities.BootStrapActivity");
				
			this.driver = new AndroidDriver(new URL("http://192.168.5.179:"+port+"/wd/hub"),capabilities);
		}
		catch(Exception e){
	    	e.printStackTrace();
	    }
